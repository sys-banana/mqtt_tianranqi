...
import com.example.zhuang.mqtt.base.Applications;
...
public class SharedPref {
    ...
    public SharedPref(Context mContext) {
        ...
        mySharedPreferences = mContext.getSharedPreferences(Contants.IMEI, Context.MODE_PRIVATE);
    }
    ...
    public static SharedPref getInstance() {
        if (sharedPref == null) {
            synchronized (SharedPref.class) {
                if (sharedPref == null) {
                    sharedPref = new SharedPref(Applications.CURRENT);
                }
            }
        }
        return sharedPref;
